...
/* package optex-0.1.0.0 */
#define VERSION_optex "0.1.0.0"
#define MIN_VERSION_optex(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "optex-0.1.0.0"

#define CURRENT_PACKAGE_KEY "optex-0.1.0.0"
